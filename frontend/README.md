...
## Native AI Backend Frontend

This frontend is configured to work with the **native-ai-backend** multi-camera tracking system.

### Prerequisites

1. **Backend must be running first** on port 5000 (see `../README.md`)
...
Open [http://localhost:3000](http://localhost:3000) with your browser to see the camera dashboard.
